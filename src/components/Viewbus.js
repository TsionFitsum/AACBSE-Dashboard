...
<div><h1 className="text-xl mb-4 text-blue-700 text-center">View Bus</h1></div>
...
py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white pointer-events-none caret-transparent" id="id" type="text" 
                        ...
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded 
py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white pointer-events-none caret-transparent" id="plate_no" type="text" 
                                value={busdata.plate_number}>
                            </input>
                        </div>
                        ...
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded 
py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white pointer-events-none caret-transparent" id="bus-route" type="text" 
                                value={busdata.bus_route} >
                            </input>
                        </div>
                        ...
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded 
py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white pointer-events-none caret-transparent" id="date-created" type="text" 
                                value={busdata.date_created} >
                            </input>
                        </div>
